...
def main(message, mode):
    ...
    if mode == 'encrypt':
        ...
        decryptFilename = 'decrypted_file.txt'
        fo = open(decryptFilename, 'w')
        fo.write(decryptedText)
        fo.close()

        EncOrDecText = decryptedText
